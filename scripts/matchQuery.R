...
p = t.test(zcor2v,xv,var.equal=F)$p.value

print(paste("P-value is",p),quote=FALSE)
print(paste("Mean DB PCC is",mean(zcor2v)),quote=FALSE)
print(paste("Mean Query PCC is",mean(xv)),quote=FALSE)
